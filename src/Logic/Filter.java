...
public class Filter {
    ...
    public ArrayList<CSVHospital> filterRatingLowerThan(ArrayList<CSVHospital> x , int y){
    ...
    public ArrayList<CSVHospital> filterRatingGreaterThan(ArrayList<CSVHospital> x , int y){
        ArrayList<CSVHospital> result = new ArrayList<CSVHospital>();
        for (CSVHospital h1 : x) {
            if (h1.getRating() != null)
                if (!h1.getRating().equals("Not Available"))
